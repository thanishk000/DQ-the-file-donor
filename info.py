...
BOT_TOKEN = environ.get('BOT_TOKEN', '6714261485:AAHtsUjeXIa0TzXKV9MTj0_Ga4MwqFP0wCI')
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://dq:dq@cluster0.rru8ktt.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "dq1")
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/mallu_moviz1')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002013229833'))
